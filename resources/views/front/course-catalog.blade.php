            ...
            @else
                ...
                <div class="text-center py-24">
                    ...
                    <div class="text-center py-16">
                        ...
                        <h3 class="text-xl font-semibold text-beige-50 mb-2">Belum Ada Kajian</h3>
                        <p class="text-beige-300">Kajian akan segera hadir. Nantikan update terbaru dari kami.</p>
                    </div>
