    ...
    <main class="min-h-screen flex items-center justify-center py-12 px-5">
        <section class="w-full max-w-lg">
            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data"
                ...
                <a href="{{ route('oauth.google.redirect') }}" class="flex items-center justify-center gap-[10px] rounded-full py-[12px] px-5 border border-LMS-green text-LMS-green hover:drop-shadow-effect transition-all duration-300 cursor-pointer">
